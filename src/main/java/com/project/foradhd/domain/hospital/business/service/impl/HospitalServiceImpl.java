package com.project.foradhd.domain.hospital.business.service.impl;
...
public class HospitalServiceImpl implements HospitalService {
    ...
    public HospitalListNearbyData getHospitalListNearby(String userId, HospitalListNearbySearchCond searchCond,
        ...
        List<HospitalListNearbyData.HospitalNearbyData> hospitalList = hospitalPaging.getContent().stream()
                .map(dto -> HospitalListNearbyData.HospitalNearbyData.builder()
    ...
    public HospitalListBookmarkData getHospitalListBookmark(String userId, Pageable pageable) {
        ...
        List<HospitalListBookmarkData.HospitalBookmarkData> hospitalList = hospitalPaging.getContent().stream()
                .map(dto -> HospitalListBookmarkData.HospitalBookmarkData.builder()
                        .hospital(dto.getHospital())
                        .build())
                .toList();
        PagingResponse paging = PagingResponse.from(hospitalPaging);
    ...
    public void createEvaluationReview(String userId, String hospitalId,
        ...
        List<Long> hospitalEvaluationQuestionIds = hospitalEvaluationReviewCreateData.getHospitalEvaluationAnswerList().stream()
                .map(HospitalEvaluationReviewCreateData.HospitalEvaluationAnswerCreateData::getHospitalEvaluationQuestionId)
                .toList();
    ...
    public void saveHospitalBookmark(String userId, String hospitalId, boolean bookmark) {
        ...
        HospitalBookmark hospitalBookmark = HospitalBookmark.builder()
                .id(new HospitalBookmark.HospitalBookmarkId(
